            ...
            <Toolbar sx={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
              ...
              <Box sx={{ '& > :not(style)': { m: 1 } }}>
                <Tooltip title="Submit a Complaint">
                  <Fab color="primary" aria-label="add" size="small" LinkComponent={Link} to="/supplier/complaints/add">
                    <AddIcon />
                  </Fab>
                </Tooltip>
              </Box>
...
export default SupplierComplaintsPage;
